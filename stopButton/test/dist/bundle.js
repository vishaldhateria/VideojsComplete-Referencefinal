...
_qunit2['default'].module('videojs-stop-button', {
...
_qunit2['default'].test('registers itself with video.js', function (assert) {
  ...
  assert.strictEqual(Player.prototype.stopButton, _srcPlugin2['default'], 'videojs-stop-button plugin was registered');
  ...
  assert.ok(this.player.hasClass('vjs-stop-button'), 'the plugin adds a class to the player');
});
